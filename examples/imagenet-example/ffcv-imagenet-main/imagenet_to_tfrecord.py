...
把 ImageNet 原始目录 → TFRecord(.tfrec) 分片
用法：
    python imagenet_to_tfrecord.py \
        --root /data/imagenet \
        --out_dir /data/imagenet_tfrec \
        --split train \
        --num_shards 1024 \
        --compress gzip
"""
...
def main():
    ...
    parser.add_argument('--root', required=True,
                        help='ImageNet root containing train/ val/')
    parser.add_argument('--split', choices=['ILSVRC2012_img_train', 'ILSVRC2012_val'], required=True)
