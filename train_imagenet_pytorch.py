...
from torch.profiler import profile, ProfilerActivity, schedule    # Profiler,用于性能分析
...
class ImageNetTrainer:
    ...
    def create_train_loader(self, train_dataset, num_workers, batch_size, distributed):
        ...
        train_dataset = torchvision.datasets.ImageFolder(train_dataset, train_transform)
        if distributed:
    ...
    def create_val_loader(self, val_dataset, num_workers, batch_size, resolution, distributed):
        ...
        val_dataset = torchvision.datasets.ImageFolder(val_dataset, val_transform)
        if distributed:
